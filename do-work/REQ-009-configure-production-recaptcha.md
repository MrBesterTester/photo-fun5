...
Must be done before REQ-007 (integration testing), since REQ-007 validates the full protection flow and reCAPTCHA degrades to pass-through when credentials are missing.
